...
import {WorkspaceTabs} from "../../features/workspace/workspace.types";
...
export class GotoService {
  ...
  workspace(workspaceID: string, activeTab?: WorkspaceTabs) { this.goto('workspace', { workspaceID, activeTab }); }
